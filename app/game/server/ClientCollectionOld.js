...
class ClientCollection extends Map {
  ...
  cut(key){
    ...
    if(key){
      ...
      // cloning object
      oldClient =  Object.assign({}, this.clientMap[key]);
      ...
      if(this.clientMap[key]) {
        ...
        this.clientArray.removeByValue(this.clientMap[key])
  ...
  get(key){
    ...
    if(key) return this.clientMap[key]
  }
  ...
  exists(key){
    ...
    if(key && this.clientMap[key]) return true;
